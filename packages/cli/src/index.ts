...
program
    .name("yigyaps")
    .description("YigYaps CLI — Marketplace and Tools for Skill Creators and Consumers")
    .version("0.1.0");
...
program
    ...
    .option("-p, --port <number>", "Port for SSE transport (not implemented)", "3000")
    .action(devCommand);
...
const mcp = program.command("mcp").description("Manage MCP host configurations");

mcp
    .command("config")
    .description("Configure a host application (e.g. Claude Desktop) to use YigYaps")
