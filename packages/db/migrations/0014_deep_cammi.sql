...
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'yy_users_email_unique') THEN ALTER TABLE "yy_users" ADD CONSTRAINT "yy_users_email_unique" UNIQUE("email"); END IF; END $$;
