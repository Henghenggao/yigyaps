...
const createPackageSchema = z.object({
  ...
  authorUrl: z.string().url().refine((url) => url.toLowerCase().startsWith("http://") || url.toLowerCase().startsWith("https://"), { message: "URL must use http or https protocol" }).optional(),
  license: z
  ...
  mcpUrl: z.string().url().refine((url) => url.toLowerCase().startsWith("http://") || url.toLowerCase().startsWith("https://"), { message: "URL must use http or https protocol" }).optional(),
  icon: z.string().max(500).optional(),
  repositoryUrl: z.string().url().refine((url) => url.toLowerCase().startsWith("http://") || url.toLowerCase().startsWith("https://"), { message: "URL must use http or https protocol" }).optional(),
  homepageUrl: z.string().url().refine((url) => url.toLowerCase().startsWith("http://") || url.toLowerCase().startsWith("https://"), { message: "URL must use http or https protocol" }).optional(),
  rules: z
    .array(
      z.object({
        path: z.string().min(1),
