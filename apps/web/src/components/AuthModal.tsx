...
export function AuthModal() {
  ...
  const [mode, setMode] = useState<
    "options" | "email-login" | "email-register"
  >("options");
  ...
  return (
    <div className="auth-modal-overlay" onClick={closeAuthModal}>
      <div className="auth-modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        {error && (
          <div
            className={`auth-modal-error ${error.includes("successful") ? "auth-modal-success" : ""}`}
          >
            {error}
          </div>
        )}
        ...
        {mode === "options" && (
          <div className="auth-options">
            ...
            <button
              className="auth-btn-provider google"
            ...
            <button
              className="auth-btn-provider email"
