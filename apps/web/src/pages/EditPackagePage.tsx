...
export function EditPackagePage() {
  ...
  useEffect(() => {
    ...
    fetchApi<Package>(`/v1/packages/${id}`)
      ...
      .catch(() =>
        addToast({ message: "Failed to load package", type: "error" }),
      )
  ...
  const handleChange = (
    ...
    if (name === "priceUsd") {
      ...
      set(
        ...
        value as (typeof formData)[keyof typeof formData],
      );
    }
  };
    ...
    <div className="app-container">
      ...
      >
        ...
        {loading ? (
          ...
          <div style={{ color: "#e74c3c", padding: "2rem 0" }}>
            Package not found.
          </div>
        ) : (
          <div
          ...
          >
            ...
            >
              <Link to="/my-packages" className="btn btn-outline">
                Cancel
              </Link>
              <button
