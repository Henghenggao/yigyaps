    ...
    rules: makeRules([
      {
        id: "py-sec-1",
        dimension: "Security",
        keywords: ["sql", "query", "execute", "cursor"],
        conclusion: "sql_injection_risk",
        weight: 1.0,
      },
      {
        id: "py-sec-2",
        dimension: "Security",
        keywords: ["eval", "exec", "compile", "input"],
        conclusion: "code_injection_risk",
        weight: 0.95,
      },
      {
        id: "py-sec-3",
        dimension: "Security",
        keywords: ["pickle", "deserialize", "yaml.load"],
        conclusion: "deserialization_risk",
        weight: 0.9,
      },
      {
        id: "py-perf-1",
        dimension: "Performance",
        keywords: ["loop", "for", "iteration", "append"],
        conclusion: "list_comprehension_opportunity",
        weight: 0.7,
      },
      {
        id: "py-perf-2",
        dimension: "Performance",
        keywords: ["n+1", "query", "orm", "lazy"],
        conclusion: "n_plus_one_query",
        weight: 0.85,
      },
      {
        id: "py-read-1",
        dimension: "Readability",
        keywords: ["except", "pass", "bare", "catch"],
        conclusion: "bare_except_antipattern",
        weight: 0.8,
      },
      {
        id: "py-test-1",
        ...
        conclusion: "testing_coverage_check",
        weight: 0.6,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        keywords: ["endpoint", "route", "path", "method"],
        conclusion: "endpoint_documented",
        weight: 0.9,
      },
      {
        id: "doc-comp-2",
        dimension: "Completeness",
        keywords: ["error", "status", "4xx", "5xx", "response"],
        conclusion: "error_codes_documented",
        weight: 0.85,
      },
      {
        id: "doc-ex-1",
        dimension: "Examples",
        keywords: ["example", "request", "curl", "body"],
        conclusion: "request_example_present",
        weight: 0.8,
      },
      {
        id: "doc-ex-2",
        dimension: "Examples",
        keywords: ["response", "json", "return", "output"],
        conclusion: "response_example_present",
        weight: 0.8,
      },
      {
        id: "doc-auth-1",
        dimension: "Authentication",
        keywords: ["auth", "token", "bearer", "api-key", "header"],
        conclusion: "auth_requirements_stated",
        weight: 0.75,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        id: "ci-sec-1",
        dimension: "Secrets",
        keywords: ["secret", "token", "password", "key", "credential"],
      ...
      },
      {
        id: "ci-sec-2",
        dimension: "Secrets",
        keywords: ["env", "environment", "variable", "hardcoded"],
        conclusion: "hardcoded_secret_risk",
        weight: 0.95,
      },
      {
        id: "ci-perf-1",
        dimension: "Performance",
        keywords: ["cache", "artifact", "restore", "save"],
        conclusion: "cache_optimization",
        weight: 0.7,
      },
      {
        id: "ci-dep-1",
        dimension: "Supply Chain",
        keywords: ["pin", "version", "sha", "digest", "lock"],
        conclusion: "dependency_pinning",
        weight: 0.85,
      },
      {
        id: "ci-dep-2",
        dimension: "Supply Chain",
        keywords: ["third-party", "action", "external", "marketplace"],
        conclusion: "third_party_action_audit",
        weight: 0.8,
      },
      {
        id: "ci-deploy-1",
        ...
        conclusion: "deployment_strategy_review",
        weight: 0.65,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        id: "ts-ready-1",
        dimension: "Readiness",
        keywords: ["test", "coverage", "jest", "vitest", "mocha"],
        conclusion: "test_coverage_adequate",
        weight: 0.8,
      },
      {
        id: "ts-ready-2",
        dimension: "Readiness",
        keywords: ["jsdoc", "type", "typedef", "annotation"],
        conclusion: "existing_type_annotations",
        weight: 0.7,
      },
      {
        id: "ts-risk-1",
        dimension: "Risk",
        keywords: ["eval", "dynamic", "require", "import()"],
        conclusion: "dynamic_pattern_risk",
        weight: 0.9,
      },
      {
        id: "ts-risk-2",
        dimension: "Risk",
        keywords: ["prototype", "this", "bind", "call", "apply"],
        conclusion: "prototype_mutation_risk",
        weight: 0.75,
      },
      {
        id: "ts-strat-1",
        dimension: "Strategy",
        keywords: ["strict", "noImplicitAny", "strictNullChecks"],
        conclusion: "strict_mode_recommendation",
        weight: 0.65,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        keywords: ["redundant", "duplicate", "denormalize", "repeated"],
        conclusion: "normalization_violation",
        weight: 0.85,
      },
      {
        id: "db-idx-1",
        dimension: "Indexing",
        keywords: ["index", "query", "where", "join", "foreign"],
        conclusion: "missing_index",
        weight: 0.9,
      },
      {
        id: "db-idx-2",
        dimension: "Indexing",
        keywords: ["composite", "covering", "partial", "expression"],
        conclusion: "index_optimization",
        weight: 0.7,
      },
      {
        id: "db-fk-1",
        dimension: "Constraints",
        keywords: ["foreign", "reference", "cascade", "restrict"],
        conclusion: "foreign_key_check",
        weight: 0.8,
      },
      {
        id: "db-fk-2",
        dimension: "Constraints",
        keywords: ["check", "unique", "not null", "default"],
        conclusion: "constraint_completeness",
        weight: 0.75,
      },
      {
        id: "db-scale-1",
        dimension: "Scalability",
        keywords: ["partition", "shard", "archive", "retention"],
        conclusion: "scalability_assessment",
        weight: 0.6,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        id: "leg-liab-1",
        dimension: "Liability",
        keywords: ["liability", "cap", "limit", "damages", "indemnity"],
        conclusion: "liability_cap_missing",
        weight: 1.0,
      },
      {
        id: "leg-liab-2",
        dimension: "Liability",
        keywords: ["consequential", "indirect", "lost profits"],
        conclusion: "consequential_damages_risk",
        weight: 0.9,
      },
      {
        id: "leg-ip-1",
        ...
        conclusion: "ip_ownership_unclear",
        weight: 0.95,
      },
      {
        id: "leg-jur-1",
        dimension: "Jurisdiction",
        keywords: ["jurisdiction", "governing law", "venue", "arbitration"],
        conclusion: "jurisdiction_risk",
        weight: 0.85,
      },
      {
        id: "leg-ren-1",
        dimension: "Renewal",
        keywords: ["auto-renew", "renewal", "notice period", "termination"],
        conclusion: "auto_renewal_trap",
        weight: 0.8,
      },
      {
        id: "leg-data-1",
        dimension: "Data Privacy",
        keywords: ["data", "gdpr", "privacy", "processing", "controller"],
        conclusion: "data_processing_review",
        weight: 0.75,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        conclusion: "high_team",
        weight: 0.3,
      },
      {
        id: "fin-team-m",
        dimension: "Team",
        keywords: ["team", "founder", "cto", "hire"],
        conclusion: "mid_team",
        weight: 0.18,
      },
      {
        id: "fin-team-l",
        dimension: "Team",
        keywords: ["solo", "first-time", "no experience"],
        conclusion: "low_team",
        weight: 0.06,
      },
      {
        id: "fin-mkt-h",
        dimension: "Market",
        keywords: ["large tam", "growing market", "underserved", "tailwind"],
        conclusion: "high_market",
        weight: 0.25,
      },
      {
        id: "fin-mkt-m",
        dimension: "Market",
        keywords: ["market", "competition", "niche"],
        conclusion: "mid_market",
        weight: 0.15,
      },
      {
        id: "fin-mkt-l",
        dimension: "Market",
        keywords: ["saturated", "declining", "no moat"],
        conclusion: "low_market",
        weight: 0.05,
      },
      {
        id: "fin-num-h",
        ...
        conclusion: "high_financials",
        weight: 0.3,
      },
      {
        id: "fin-num-m",
        dimension: "Financials",
        keywords: ["revenue", "mrr", "arr", "growth"],
        conclusion: "mid_financials",
        weight: 0.18,
      },
      {
        id: "fin-num-l",
        dimension: "Financials",
        keywords: ["pre-revenue", "high burn", "no runway"],
        conclusion: "low_financials",
        weight: 0.06,
      },
      {
        id: "fin-tech-h",
        dimension: "Technology",
        keywords: ["patent", "defensible", "proprietary", "moat"],
        conclusion: "high_technology",
        weight: 0.15,
      },
      {
        id: "fin-tech-m",
        dimension: "Technology",
        keywords: ["technology", "platform", "scalable"],
        conclusion: "mid_technology",
        weight: 0.09,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        keywords: ["interview", "survey", "usability test", "diary study"],
        conclusion: "methodology_appropriate",
        weight: 0.8,
      },
      {
        id: "ux-meth-2",
        dimension: "Methodology",
        keywords: ["sample size", "participants", "recruitment", "bias"],
        conclusion: "sample_adequacy",
        weight: 0.75,
      },
      {
        id: "ux-ins-1",
        dimension: "Insights",
        keywords: ["theme", "pattern", "finding", "insight", "behavior"],
        conclusion: "insight_quality_check",
        weight: 0.9,
      },
      {
        id: "ux-ins-2",
        dimension: "Insights",
        keywords: ["quote", "evidence", "observed", "data point"],
        conclusion: "evidence_backed_insight",
        weight: 0.85,
      },
      {
        id: "ux-act-1",
        dimension: "Actionability",
        keywords: ["recommendation", "action", "priority", "next step"],
        conclusion: "actionable_recommendation",
        weight: 0.7,
      },
      {
        id: "ux-heur-1",
        ...
        conclusion: "nielsen_heuristic_match",
        weight: 0.65,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        conclusion: "high_technical",
        weight: 0.35,
      },
      {
        id: "hire-tech-m",
        dimension: "Technical Depth",
        keywords: ["adequate", "mid-level", "good understanding", "competent"],
        conclusion: "mid_technical",
        weight: 0.21,
      },
      {
        id: "hire-tech-l",
        dimension: "Technical Depth",
        keywords: ["junior", "gaps", "struggled", "incorrect"],
        conclusion: "low_technical",
        weight: 0.07,
      },
      {
        id: "hire-comm-h",
        dimension: "Communication",
        keywords: ["articulate", "clear", "collaborative", "active listener"],
        conclusion: "high_communication",
        weight: 0.2,
      },
      {
        id: "hire-comm-m",
        dimension: "Communication",
        keywords: ["communicates", "explains", "responds"],
        conclusion: "mid_communication",
        weight: 0.12,
      },
      {
        id: "hire-cult-h",
        dimension: "Culture Fit",
        keywords: ["values aligned", "team player", "adaptable", "ownership"],
        conclusion: "high_culture",
        weight: 0.2,
      },
      {
        id: "hire-cult-m",
        dimension: "Culture Fit",
        keywords: ["culture", "team", "work style"],
        conclusion: "mid_culture",
        weight: 0.12,
      },
      {
        id: "hire-grow-h",
        dimension: "Growth Potential",
        keywords: ["fast learner", "curious", "ambitious", "self-driven"],
        conclusion: "high_growth",
        weight: 0.25,
      },
      {
        id: "hire-grow-m",
        dimension: "Growth Potential",
        keywords: ["learning", "growth", "improve"],
        conclusion: "mid_growth",
        weight: 0.15,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        id: "mkt-seo-1",
        dimension: "SEO",
        keywords: ["keyword", "search volume", "ranking", "serp", "backlink"],
        conclusion: "seo_strategy_check",
        weight: 0.8,
      },
      {
        id: "mkt-seo-2",
        dimension: "SEO",
        keywords: ["on-page", "meta", "title", "h1", "alt text"],
        conclusion: "on_page_optimization",
        weight: 0.7,
      },
      {
        id: "mkt-aud-1",
        dimension: "Audience",
        keywords: ["persona", "audience", "target", "segment", "icp"],
        conclusion: "audience_alignment",
        weight: 0.85,
      },
      {
        id: "mkt-aud-2",
        ...
        conclusion: "funnel_stage_mapping",
        weight: 0.75,
      },
      {
        id: "mkt-dist-1",
        dimension: "Distribution",
        keywords: ["channel", "social", "email", "newsletter", "syndication"],
        conclusion: "distribution_strategy",
        weight: 0.7,
      },
      {
        id: "mkt-conv-1",
        dimension: "Conversion",
        keywords: ["cta", "conversion", "lead magnet", "signup", "download"],
        conclusion: "conversion_optimization",
        weight: 0.65,
      },
    ]),
  },
