...
- Contradiction resolution across sources`,
    ...
    rules: makeRules([
      // Market Definition
      {
        ...
        conclusion: "market_boundary_defined",
        weight: 0.9,
      },
      {
        id: "mr-def-2",
        ...
        conclusion: "time_horizon_set",
        weight: 0.8,
      },
      // TAM/SAM/SOM
      {
        id: "mr-tam-1",
        dimension: "Market Sizing",
        keywords: ["tam", "total addressable market", "addressable"],
        conclusion: "tam_sizing_required",
        weight: 0.95,
      },
      {
        id: "mr-sam-1",
        dimension: "Market Sizing",
        keywords: ["sam", "serviceable addressable", "serviceable market"],
        conclusion: "sam_sizing_required",
        weight: 0.9,
      },
      {
        id: "mr-som-1",
        ...
        conclusion: "som_sizing_required",
        weight: 0.9,
      },
      {
        id: "mr-meth-1",
        dimension: "Sizing Methodology",
        keywords: [
          "bottom-up",
          "top-down",
          "triangulation",
        ...
        conclusion: "sizing_methodology_present",
        weight: 0.85,
      },
      // Competitive Landscape
      {
        ...
        conclusion: "competitive_map_needed",
        weight: 0.9,
      },
      {
        id: "mr-comp-2",
        ...
        conclusion: "porters_five_forces",
        weight: 0.85,
      },
      {
        id: "mr-comp-3",
        ...
        conclusion: "strategic_grouping",
        weight: 0.8,
      },
      // Growth Analysis
      {
        id: "mr-grow-1",
        dimension: "Growth Drivers",
        keywords: [
          "driver",
          "catalyst",
          "tailwind",
        ...
        conclusion: "growth_drivers_identified",
        weight: 0.85,
      },
      {
        id: "mr-grow-2",
        ...
        conclusion: "growth_inhibitors_identified",
        weight: 0.85,
      },
      {
        id: "mr-pestle-1",
      ...
      // Customer Analysis
      {
        ...
        conclusion: "customer_segmentation",
        weight: 0.8,
      },
      {
        id: "mr-cust-2",
        ...
        conclusion: "buying_behavior_analysis",
        weight: 0.75,
      },
      // Data Sources
      {
        ...
        conclusion: "multi_source_research",
        weight: 0.9,
      },
      {
        id: "mr-data-2",
        ...
        conclusion: "authoritative_sources",
        weight: 0.85,
      },
      // Strategic Output
      {
        ...
        conclusion: "strategic_recommendation",
        weight: 0.85,
      },
    ]),
  },
...
- Prior art assessment methodology`,
    ...
    rules: makeRules([
      // Search Strategy
      {
        ...
        conclusion: "ipc_classification_used",
        weight: 0.95,
      },
      {
        id: "pa-key-1",
        ...
        conclusion: "keyword_strategy_defined",
        weight: 0.85,
      },
      {
        id: "pa-asn-1",
        ...
        conclusion: "assignee_filter_applied",
        weight: 0.8,
      },
      // Landscape Mapping
      {
        id: "pa-trend-1",
        dimension: "Filing Trends",
        keywords: [
          "filing trend",
          "annual filing",
          "year over year",
        ...
        conclusion: "filing_trend_analyzed",
        weight: 0.9,
      },
      {
        id: "pa-geo-1",
        ...
        conclusion: "geographic_distribution",
        weight: 0.85,
      },
      {
        id: "pa-play-1",
        ...
        conclusion: "player_ranking",
        weight: 0.9,
      },
      // Technology Analysis
      {
        id: "pa-clus-1",
        dimension: "Technology Clustering",
        keywords: [
          "cluster",
          "sub-domain",
          "technology area",
        ...
        conclusion: "technology_clustering",
        weight: 0.85,
      },
      {
        id: "pa-evol-1",
        ...
        conclusion: "technology_evolution",
        weight: 0.8,
      },
      // White Space
      {
        id: "pa-ws-1",
        dimension: "White Space",
        keywords: [
          "white space",
          "gap",
          "unclaimed",
        ...
        conclusion: "white_space_identified",
        weight: 0.95,
      },
      {
        id: "pa-ws-2",
        ...
        conclusion: "claim_matrix_analysis",
        weight: 0.9,
      },
      // Citation Analysis
      {
        id: "pa-fwd-1",
        dimension: "Forward Citations",
        keywords: [
          "forward citation",
          "cited by",
          "built upon",
        ...
        conclusion: "forward_citation_analysis",
        weight: 0.85,
      },
      {
        id: "pa-bwd-1",
        dimension: "Backward Citations",
        keywords: [
          "backward citation",
          "prior art",
          "references cited",
        ...
        conclusion: "backward_citation_analysis",
        weight: 0.85,
      },
      // FTO Assessment
      {
        id: "pa-fto-1",
        dimension: "Freedom to Operate",
        keywords: [
          "freedom to operate",
          "fto",
          "infringement",
        ...
        conclusion: "fto_assessment",
        weight: 0.95,
      },
      {
        id: "pa-exp-1",
        dimension: "Patent Status",
        keywords: [
          "expiry",
          "expired",
          "active",
        ...
        conclusion: "patent_status_check",
        weight: 0.9,
      },
      // Strategic Output
      {
...
- CAPTCHA classification and routing`,
    ...
    rules: makeRules([
      // Form Detection
      {
        ...
        conclusion: "form_elements_detected",
        weight: 0.95,
      },
      {
        id: "fa-disc-2",
        ...
        conclusion: "field_labels_mapped",
        weight: 0.9,
      },
      {
        id: "fa-sec-1",
        dimension: "Security Fields",
        keywords: ["csrf", "token", "_token", "honeypot", "hidden", "nonce"],
        conclusion: "security_fields_detected",
        weight: 0.95,
      },
      // Field Type Handling
      {
        ...
        conclusion: "date_picker_strategy",
        weight: 0.9,
      },
      {
        id: "fa-type-2",
        ...
        conclusion: "file_upload_strategy",
        weight: 0.9,
      },
      {
        id: "fa-type-3",
      ...
      },
      {
        ...
        conclusion: "autocomplete_strategy",
        weight: 0.85,
      },
      // Multi-Step Handling
      {
        ...
        conclusion: "wizard_flow_detected",
        weight: 0.95,
      },
      {
        id: "fa-cond-1",
        dimension: "Conditional Logic",
        keywords: [
          "conditional",
          "depends on",
          "show if",
        ...
        conclusion: "conditional_fields_detected",
        weight: 0.9,
      },
      // Validation
      {
        ...
        conclusion: "validation_rules_extracted",
        weight: 0.9,
      },
      {
        id: "fa-val-2",
        ...
        conclusion: "realtime_validation_handling",
        weight: 0.85,
      },
      // CAPTCHA & Anti-bot
      {
        ...
        conclusion: "captcha_routing_needed",
        weight: 1.0,
      },
      {
        id: "fa-cap-2",
        ...
        conclusion: "antibot_evasion_strategy",
        weight: 0.9,
      },
      // Error Recovery
      {
        ...
        conclusion: "error_recovery_loop",
        weight: 0.9,
      },
      {
        id: "fa-sess-1",
        dimension: "Session Management",
        keywords: [
          "session",
          "cookie",
          "timeout",
      ...
      // Confirmation
      {
        ...
        conclusion: "confirmation_captured",
        weight: 0.85,
      },
    ]),
  },
...
- Cost and latency optimization across agent calls`,
    ...
    rules: makeRules([
      ...
      },
      {
        ...
        conclusion: "subtask_bounded",
        weight: 0.9,
      },
      // Agent Roles
      {
        id: "ma-role-1",
        dimension: "Agent Roles",
        keywords: [
          "role",
          "agent",
          "specialist",
      ...
      },
      {
        ...
        conclusion: "hierarchical_pattern",
        weight: 0.85,
      },
      // Communication
      {
        ...
        conclusion: "communication_protocol",
        weight: 0.9,
      },
      {
        id: "ma-comm-2",
        ...
        conclusion: "structured_communication",
        weight: 0.85,
      },
      // State Management
      {
        ...
        conclusion: "state_management_strategy",
        weight: 0.9,
      },
      {
        id: "ma-state-2",
        ...
        conclusion: "memory_augmentation",
        weight: 0.85,
      },
      // Failure Handling
      {
        ...
        conclusion: "failure_recovery_defined",
        weight: 0.95,
      },
      {
        id: "ma-fail-2",
        ...
        conclusion: "human_escalation_path",
        weight: 0.9,
      },
      // Termination
      {
        ...
        conclusion: "termination_defined",
        weight: 0.9,
      },
      // Observability
      {
        ...
        conclusion: "observability_configured",
        weight: 0.8,
      },
      // Cost & Latency
      {
        ...
        conclusion: "efficiency_considered",
        weight: 0.75,
      },
    ]),
  },
...
- Production drift detection requires baseline comparison`,
    ...
    rules: makeRules([
      // Indexing
      {
        ...
        conclusion: "chunking_strategy_evaluated",
        weight: 0.95,
      },
      {
        id: "rag-chunk-2",
      ...
      // Embedding
      {
        ...
        conclusion: "embedding_model_selection",
        weight: 0.9,
      },
      {
        id: "rag-emb-2",
        ...
        conclusion: "embedding_dimensionality",
        weight: 0.8,
      },
      // Retrieval Metrics
      {
        id: "rag-prec-1",
        dimension: "Retrieval Precision",
        keywords: [
          "precision",
          "context precision",
          "relevant retrieved",
        ...
        conclusion: "retrieval_precision_check",
        weight: 0.95,
      },
      {
        id: "rag-rec-1",
        ...
        conclusion: "retrieval_recall_check",
        weight: 0.95,
      },
      {
        id: "rag-rerank-1",
        dimension: "Re-ranking",
        keywords: [
          "rerank",
          "cross-encoder",
          "cohere rerank",
      ...
      },
      {
        ...
        conclusion: "answer_relevance_check",
        weight: 0.9,
      },
      {
        id: "rag-cite-1",
        ...
        conclusion: "citation_accuracy",
        weight: 0.85,
      },
      // Vector Store
      {
        id: "rag-vs-1",
        dimension: "Vector Store",
        keywords: [
          "vector store",
          "pinecone",
          "weaviate",
        ...
        conclusion: "vector_store_assessment",
        weight: 0.8,
      },
      {
        id: "rag-vs-2",
        ...
        conclusion: "vector_store_performance",
        weight: 0.8,
      },
      // Query Processing
      {
        id: "rag-qry-1",
        dimension: "Query Processing",
        keywords: [
          "query expansion",
      ...
      // Evaluation
      {
        ...
        conclusion: "evaluation_framework_present",
        weight: 0.9,
      },
    ]),
  },
...
- Context-dependent vulnerability assessment`,
    ...
    rules: makeRules([
      // LLM01: Prompt Injection
      {
        ...
        conclusion: "direct_injection_vector",
        weight: 1.0,
      },
      {
        id: "ls-inj-2",
        ...
        conclusion: "indirect_injection_risk",
        weight: 0.95,
      },
      {
        id: "ls-inj-3",
        ...
        conclusion: "jailbreak_pattern",
        weight: 0.95,
      },
      // LLM06: Sensitive Info Disclosure
      {
        id: "ls-leak-1",
        dimension: "Info Disclosure",
        keywords: [
          "system prompt",
        ...
        conclusion: "system_prompt_extraction",
        weight: 0.95,
      },
      {
        id: "ls-leak-2",
        ...
        conclusion: "secret_in_prompt_risk",
        weight: 1.0,
      },
      {
        id: "ls-pii-1",
        ...
        conclusion: "pii_leakage_risk",
        weight: 0.95,
      },
      // LLM02: Output Handling
      {
        id: "ls-out-1",
        dimension: "Output Injection",
        keywords: [
          "markdown",
          "html",
          "javascript",
        ...
        conclusion: "output_injection_risk",
        weight: 0.9,
      },
      {
        id: "ls-out-2",
        dimension: "Output Handling",
        keywords: [
          "unsanitized output",
          "raw llm output",
          "direct render",
        ...
        conclusion: "unsafe_output_handling",
        weight: 0.95,
      },
      // LLM08: Excessive Agency
      {
        ...
        conclusion: "high_impact_tool_access",
        weight: 0.95,
      },
      {
        id: "ls-agen-2",
        ...
        conclusion: "insufficient_oversight",
        weight: 0.9,
      },
      // LLM07: Plugin Security
      {
        id: "ls-tool-1",
        dimension: "Tool Call Security",
        keywords: [
          "function call",
          "tool call",
          "plugin",
        ...
        conclusion: "tool_parameter_injection",
        weight: 0.9,
      },
      {
        id: "ls-tool-2",
        ...
        conclusion: "tool_injection_chaining",
        weight: 0.95,
      },
      // LLM04: DoS
      {
        ...
        conclusion: "resource_exhaustion_risk",
        weight: 0.85,
      },
      // Guardrails
      {
        ...
        conclusion: "guardrail_presence_check",
        weight: 0.9,
      },
      {
        id: "ls-guard-2",
        ...
        conclusion: "guardrail_bypass_risk",
        weight: 0.95,
      },
    ]),
  },
...
- Supply chain security spans registry → build → deploy`,
    ...
    rules: makeRules([
      // RBAC
      {
        ...
        conclusion: "overprivileged_rbac",
        weight: 1.0,
      },
      {
        id: "k8-rbac-2",
        ...
        conclusion: "dangerous_verb_permission",
        weight: 0.95,
      },
      {
        id: "k8-rbac-3",
        ...
        conclusion: "service_account_risk",
        weight: 0.9,
      },
      // Network Policy
      {
        ...
        conclusion: "network_policy_baseline",
        weight: 0.95,
      },
      {
        id: "k8-net-2",
        ...
        conclusion: "missing_network_policy",
        weight: 0.95,
      },
      // Pod Security
      {
        id: "k8-pod-1",
        dimension: "Pod Security",
        keywords: [
          "privileged: true",
          "runasroot",
          "runasuser: 0",
        ...
        conclusion: "privileged_container",
        weight: 1.0,
      },
      {
        id: "k8-pod-2",
        ...
        conclusion: "mutable_filesystem_risk",
        weight: 0.9,
      },
      {
        id: "k8-pod-3",
        ...
        conclusion: "capabilities_audit",
        weight: 0.9,
      },
      {
        id: "k8-pod-4",
        dimension: "Pod Security",
        keywords: ["hostpid", "hostnetwork", "hostipc", "host namespace"],
        conclusion: "host_namespace_risk",
        weight: 0.95,
      },
      // Resource Management
      {
        ...
        conclusion: "resource_limits_check",
        weight: 0.85,
      },
      // Secrets
      {
        ...
        conclusion: "secret_management_check",
        weight: 0.9,
      },
      {
        id: "k8-sec-2",
        ...
        conclusion: "secret_exposure_risk",
        weight: 1.0,
      },
      // Control Plane
      {
        ...
        conclusion: "apiserver_hardening",
        weight: 0.95,
      },
      {
        id: "k8-etcd-1",
        ...
        conclusion: "etcd_security",
        weight: 0.9,
      },
      // Images
      {
        id: "k8-img-1",
        dimension: "Image Security",
        keywords: [
          "latest tag",
          "unscanned",
          "public registry",
        ...
        conclusion: "image_security_risk",
        weight: 0.9,
      },
      {
        id: "k8-img-2",
        dimension: "Image Security",
        keywords: ["cosign", "sigstore", "image signing", "sbom", "provenance"],
        conclusion: "supply_chain_security",
        weight: 0.85,
      },
    ]),
  },
...
- Governance overlaps with legal/compliance requirements`,
    ...
    rules: makeRules([
      // Medallion Architecture
      {
        ...
        conclusion: "medallion_architecture_check",
        weight: 0.9,
      },
      {
        id: "dl-med-2",
      ...
      },
      {
        ...
        conclusion: "obt_tradeoff_assessment",
        weight: 0.8,
      },
      // Orchestration
      {
        ...
        conclusion: "orchestration_design",
        weight: 0.9,
      },
      {
        id: "dl-orch-2",
        ...
        conclusion: "pipeline_reliability",
        weight: 0.85,
      },
      // Data Quality
      {
        ...
        conclusion: "quality_framework_present",
        weight: 0.9,
      },
      {
        id: "dl-qual-2",
        ...
        conclusion: "quality_dimensions_covered",
        weight: 0.85,
      },
      // Schema Evolution
      {
        ...
        conclusion: "schema_evolution_strategy",
        weight: 0.9,
      },
      {
        id: "dl-sch-2",
      ...
      },
      {
        ...
        conclusion: "governance_framework",
        weight: 0.85,
      },
      // Performance
      {
        ...
        conclusion: "storage_optimization",
        weight: 0.85,
      },
      {
        id: "dl-cost-1",
...
async function main() {
  ...
  for (const [index, pkg] of THREE_STAR_SKILLS.entries()) {
    ...
    if (existing) {
      console.log(
        `  skip (${index + 1}/${THREE_STAR_SKILLS.length}): ${pkg.packageId}`,
      );
      skipped++;
      continue;
    }
    ...
    created++;
    console.log(
      `  + (${index + 1}/${THREE_STAR_SKILLS.length}) ${pkg.displayName}`,
    );
  }
