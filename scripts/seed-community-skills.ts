    ...
    rules: makeRules([
      {
        ...
        keywords: ["add", "new", "implement", "introduce", "create"],
        conclusion: "type_feat",
        weight: 0.9,
      },
      {
        id: "gc-type-2",
      ...
      },
      {
        id: "gc-type-3",
        dimension: "Type Detection",
        keywords: ["refactor", "restructure", "reorganize", "move", "rename"],
        conclusion: "type_refactor",
        weight: 0.8,
      },
      {
        id: "gc-type-4",
        ...
        conclusion: "type_test",
        weight: 0.85,
      },
      {
        id: "gc-type-5",
        dimension: "Type Detection",
        keywords: ["docs", "readme", "comment", "jsdoc", "documentation"],
        conclusion: "type_docs",
        weight: 0.8,
      },
      {
        id: "gc-scope-1",
      ...
      },
      {
        ...
        conclusion: "scope_auth",
        weight: 0.75,
      },
      {
        id: "gc-scope-3",
        dimension: "Scope",
        keywords: ["ui", "component", "page", "layout", "style"],
        conclusion: "scope_ui",
        weight: 0.7,
      },
      {
        ...
        keywords: ["breaking", "BREAKING", "remove", "rename", "incompatible"],
        conclusion: "breaking_change_flag",
        weight: 1.0,
      },
      {
        id: "gc-body-1",
        dimension: "Body Necessity",
        keywords: ["complex", "multiple files", "migration", "upgrade"],
        conclusion: "body_recommended",
        weight: 0.6,
      },
    ]),
  },
...
- **Flags**: Case sensitivity, multiline, global`,
    ...
    rules: makeRules([
      {
        id: "rx-type-1",
        dimension: "Pattern Type",
        keywords: ["email", "mail", "address"],
        conclusion: "pattern_email",
        weight: 0.95,
      },
      {
        id: "rx-type-2",
        dimension: "Pattern Type",
        keywords: ["url", "http", "https", "link", "website"],
        conclusion: "pattern_url",
        weight: 0.95,
      },
      {
        id: "rx-type-3",
      ...
      },
      {
        ...
        conclusion: "pattern_datetime",
        weight: 0.9,
      },
      {
        id: "rx-type-5",
        dimension: "Pattern Type",
        keywords: ["ip", "ipv4", "ipv6", "address"],
        conclusion: "pattern_ip",
        weight: 0.9,
      },
      {
        id: "rx-type-6",
        ...
        conclusion: "pattern_uuid",
        weight: 0.85,
      },
      {
        id: "rx-anchor-1",
        dimension: "Anchoring",
        keywords: ["start", "beginning", "end", "whole", "exact"],
        conclusion: "anchors_recommended",
        weight: 0.8,
      },
      {
        id: "rx-group-1",
        dimension: "Groups",
        keywords: ["capture", "group", "extract", "named"],
        conclusion: "named_group_recommended",
        weight: 0.7,
      },
      {
        id: "rx-quant-1",
        ...
        conclusion: "quantifier_precision",
        weight: 0.75,
      },
      {
        id: "rx-flag-1",
        dimension: "Flags",
        keywords: ["case insensitive", "multiline", "global", "all matches"],
        conclusion: "flag_recommendation",
        weight: 0.65,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        conclusion: "action_item_detected",
        weight: 0.95,
      },
      {
        id: "mn-act-2",
        dimension: "Action Detection",
        keywords: ["responsible", "take care", "handle", "own", "assigned"],
        conclusion: "ownership_signal",
        weight: 0.85,
      },
      {
        id: "mn-own-1",
      ...
      },
      {
        ...
        conclusion: "deadline_extracted",
        weight: 0.85,
      },
      {
        id: "mn-dead-2",
        dimension: "Deadline",
        keywords: ["asap", "urgent", "immediately", "today", "tomorrow"],
        conclusion: "urgent_deadline",
        weight: 0.9,
      },
      {
        id: "mn-dec-1",
    ...
    rules: makeRules([
      {
        ...
        conclusion: "lookup_formula",
        weight: 0.9,
      },
      {
        id: "sf-look-2",
        dimension: "Lookup",
        keywords: ["vlookup", "xlookup", "index match", "hlookup"],
        conclusion: "lookup_type_specified",
        weight: 0.95,
      },
      {
        id: "sf-cond-1",
        dimension: "Conditional",
        keywords: ["if", "when", "condition", "criteria", "where", "filter"],
        conclusion: "conditional_formula",
        weight: 0.85,
      },
      {
        id: "sf-cond-2",
        dimension: "Conditional",
        keywords: ["sum if", "count if", "average if", "sumproduct"],
        conclusion: "conditional_aggregation",
        weight: 0.9,
      },
      {
        id: "sf-text-1",
      ...
      },
      {
        ...
        conclusion: "error_handling_needed",
        weight: 0.85,
      },
      {
        id: "sf-ref-1",
        dimension: "Reference",
        keywords: ["absolute", "lock", "fixed", "dollar sign", "copy formula"],
        conclusion: "absolute_reference_needed",
        weight: 0.7,
      },
    ]),
  },
...
Google's OKR framework (John Doerr — *Measure What Matters*)`,
    ...
    rules: makeRules([
      ...
      },
      {
        ...
        conclusion: "stretch_goal",
        weight: 0.8,
      },
      {
        id: "okr-outp-1",
        dimension: "Outcome vs Output",
        keywords: ["launch", "deliver", "complete", "ship", "implement"],
        conclusion: "output_kr_warning",
        weight: 0.85,
      },
      {
        id: "okr-casc-1",
        ...
        conclusion: "cascade_level_defined",
        weight: 0.75,
      },
      {
        id: "okr-insp-1",
        dimension: "Objective Quality",
        keywords: ["inspire", "vision", "purpose", "why", "mission"],
        conclusion: "objective_inspiring",
        weight: 0.7,
      },
    ]),
  },
...
- **Negative Prompt**: Common artifacts to exclude`,
    ...
    rules: makeRules([
      ...
      },
      {
        ...
        conclusion: "style_defined",
        weight: 0.85,
      },
      {
        id: "img-styl-2",
        dimension: "Style",
        keywords: ["by", "style of", "inspired by", "in the style"],
        conclusion: "artist_reference",
        weight: 0.75,
      },
      {
        id: "img-comp-1",
      ...
      },
      {
        ...
        conclusion: "quality_modifiers",
        weight: 0.75,
      },
      {
        id: "img-neg-1",
        dimension: "Negative Prompt",
        keywords: [
          "no",
          "avoid",
          "without",
        ...
        conclusion: "negative_prompt_present",
        weight: 0.7,
      },
      {
        id: "img-ar-1",
    ...
    rules: makeRules([
      {
        ...
        conclusion: "hook_pattern_interrupt",
        weight: 0.95,
      },
      {
        id: "vs-hook-2",
      ...
      },
      {
        ...
        conclusion: "problem_established",
        weight: 0.85,
      },
      {
        id: "vs-evid-1",
      ...
      },
      {
        ...
        conclusion: "structure_signposted",
        weight: 0.75,
      },
      {
        id: "vs-cta-1",
    ...
    rules: makeRules([
      {
        ...
        conclusion: "job_title_extracted",
        weight: 0.95,
      },
      {
        id: "jl-level-1",
        ...
        conclusion: "seniority_classified",
        weight: 0.9,
      },
      {
        id: "jl-loc-1",
        dimension: "Location Policy",
        keywords: [
          "remote",
          "hybrid",
          "on-site",
        ...
        conclusion: "remote_policy_extracted",
        weight: 0.9,
      },
      {
        id: "jl-comp-1",
        ...
        conclusion: "compensation_extracted",
        weight: 0.85,
      },
      {
        id: "jl-req-1",
        ...
        conclusion: "hard_requirements",
        weight: 0.9,
      },
      {
        id: "jl-req-2",
        dimension: "Requirements",
        keywords: ["nice to have", "preferred", "bonus", "plus", "ideally"],
        conclusion: "soft_requirements",
        weight: 0.85,
      },
      {
        id: "jl-ben-1",
...
Structured verdict with per-dimension scores (1-5) and key findings summary.`,
    ...
    rules: makeRules([
      ...
      },
      {
        ...
        conclusion: "descriptive_methodology",
        weight: 0.8,
      },
      {
        id: "ap-samp-1",
      ...
      },
      {
        ...
        conclusion: "significance_reported",
        weight: 0.85,
      },
      {
        id: "ap-repr-1",
        ...
        conclusion: "reproducibility_strong",
        weight: 0.9,
      },
      {
        id: "ap-lim-1",
        ...
        conclusion: "limitations_acknowledged",
        weight: 0.85,
      },
      {
        id: "ap-pub-1",
        ...
        conclusion: "high_impact_venue",
        weight: 0.75,
      },
      {
        id: "ap-pub-2",
        dimension: "Publication",
        keywords: ["arxiv", "preprint", "ssrn", "biorxiv", "not peer reviewed"],
        conclusion: "preprint_caution",
        weight: 0.7,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        conclusion: "authoritative_source",
        weight: 0.95,
      },
      {
        id: "fc-src-2",
      ...
      },
      {
        ...
        conclusion: "appropriately_hedged",
        weight: 0.7,
      },
      {
        id: "fc-rec-1",
        dimension: "Recency",
        keywords: ["2024", "2025", "2026", "recent", "latest", "new study"],
        conclusion: "recency_check",
        weight: 0.75,
      },
      {
        id: "fc-coi-1",
        ...
        conclusion: "conflict_of_interest_flag",
        weight: 0.9,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        keywords: ["article", "blog", "news", "post", "story"],
        conclusion: "content_article",
        weight: 0.85,
      },
      {
        id: "wx-type-2",
        ...
        conclusion: "content_table",
        weight: 0.9,
      },
      {
        id: "wx-type-3",
        dimension: "Content Type",
        keywords: ["product", "price", "add to cart", "shop", "buy", "sku"],
        conclusion: "content_product",
        weight: 0.9,
      },
      {
        id: "wx-type-4",
        dimension: "Content Type",
        keywords: ["contact", "email", "phone", "address", "team", "directory"],
        conclusion: "content_contact",
        weight: 0.85,
      },
      {
        id: "wx-pagi-1",
        ...
        conclusion: "pagination_detected",
        weight: 0.9,
      },
      {
        id: "wx-auth-1",
      ...
      },
      {
        ...
        conclusion: "rate_limit_handling",
        weight: 0.9,
      },
      {
        id: "wx-comp-1",
...
\`\`\``,
    ...
    rules: makeRules([
      {
        id: "pm-price-1",
        dimension: "Price Detection",
        keywords: ["$", "€", "£", "price", "cost", "msrp", "retail"],
        conclusion: "price_detected",
        weight: 0.95,
      },
      {
        id: "pm-disc-1",
        ...
        conclusion: "discount_detected",
        weight: 0.9,
      },
      {
        id: "pm-prod-1",
        dimension: "Product Identity",
        keywords: ["sku", "asin", "model", "upc", "isbn", "barcode", "mpn"],
        conclusion: "product_identified",
        weight: 0.9,
      },
      {
        id: "pm-alert-1",
        dimension: "Alert Config",
        keywords: [
          "alert when",
          "notify",
          "drop below",
      ...
      },
      {
        ...
        conclusion: "availability_tracked",
        weight: 0.85,
      },
      {
        id: "pm-var-1",
    ...
    rules: makeRules([
      {
        ...
        conclusion: "accessibility_issue",
        weight: 0.95,
      },
      {
        id: "ux-a11y-2",
        dimension: "Accessibility",
        keywords: ["contrast", "color ratio", "wcag", "aa", "aaa"],
        conclusion: "contrast_issue",
        weight: 0.9,
      },
      {
        id: "ux-perf-1",
      ...
      },
      {
        ...
        conclusion: "performance_optimization",
        weight: 0.85,
      },
      {
        id: "ux-nav-1",
      ...
      },
      {
        ...
        conclusion: "form_accessibility",
        weight: 0.8,
      },
      {
        id: "ux-sec-1",
        dimension: "Security Headers",
        keywords: ["https", "csp", "mixed content", "hsts", "x-frame-options"],
        conclusion: "security_header_check",
        weight: 0.75,
      },
    ]),
  },
...
- **Market Signals**: Funding, hiring, partnerships, press`,
    ...
    rules: makeRules([
      ...
      },
      {
        ...
        conclusion: "pricing_model_analyzed",
        weight: 0.9,
      },
      {
        id: "ci-pos-1",
        ...
        conclusion: "positioning_identified",
        weight: 0.85,
      },
      {
        id: "ci-moat-1",
      ...
      },
      {
        ...
        conclusion: "weakness_identified",
        weight: 0.85,
      },
      {
        id: "ci-sig-1",
        dimension: "Market Signals",
        keywords: [
          "funding",
          "raised",
          "acquisition",
        ...
        conclusion: "market_signal_detected",
        weight: 0.8,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        conclusion: "engagement_calculated",
        weight: 0.95,
      },
      {
        id: "sm-eng-2",
      ...
      },
      {
        ...
        conclusion: "value_content_present",
        weight: 0.85,
      },
      {
        id: "sm-cont-2",
        ...
        conclusion: "promotional_ratio_check",
        weight: 0.8,
      },
      {
        id: "sm-nich-1",
        dimension: "Niche Authority",
        keywords: [
          "expert",
          "authority",
          "known for",
      ...
      },
      {
        ...
        conclusion: "posting_frequency_assessed",
        weight: 0.75,
      },
      {
        id: "sm-grow-1",
...
Original query → EXPLAIN ANALYZE recommendation → optimized query + index DDL`,
    ...
    rules: makeRules([
      {
        id: "sq-n1-1",
        dimension: "N+1 Detection",
        keywords: ["loop", "for each", "per row", "n+1", "orm", "lazy load"],
        conclusion: "n_plus_one_risk",
        weight: 1.0,
      },
      {
        id: "sq-idx-1",
        dimension: "Missing Index",
        keywords: ["where", "join on", "order by", "group by", "filter"],
        conclusion: "index_candidate",
        weight: 0.9,
      },
      {
        id: "sq-sel-1",
        dimension: "SELECT *",
        keywords: ["select *", "select all"],
        conclusion: "select_star_antipattern",
        weight: 0.8,
      },
      {
        id: "sq-sub-1",
        ...
        conclusion: "subquery_optimization",
        weight: 0.85,
      },
      {
        id: "sq-pag-1",
        dimension: "Pagination",
        keywords: ["offset", "limit offset", "page", "skip"],
        conclusion: "offset_pagination_issue",
        weight: 0.8,
      },
      {
        id: "sq-sarg-1",
        dimension: "SARGable",
        keywords: ["function(column", "lower(", "upper(", "cast(", "date("],
        conclusion: "non_sargable_predicate",
        weight: 0.9,
      },
      {
        id: "sq-null-1",
        dimension: "NULL Handling",
        keywords: ["is null", "is not null", "coalesce", "nullif"],
        conclusion: "null_handling_check",
        weight: 0.7,
      },
      {
        id: "sq-txn-1",
        ...
        conclusion: "transaction_pattern_check",
        weight: 0.75,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        id: "dk-root-1",
        dimension: "Privilege",
        keywords: ["user root", "run as root", "no user", "uid 0"],
        conclusion: "root_user_risk",
        weight: 1.0,
      },
      {
        id: "dk-sec-1",
        ...
        conclusion: "secret_in_image",
        weight: 1.0,
      },
      {
        id: "dk-pin-1",
        dimension: "Image Pinning",
        keywords: [
          "latest",
          ":stable",
          "FROM ubuntu",
        ...
        conclusion: "unpinned_base_image",
        weight: 0.9,
      },
      {
        id: "dk-copy-1",
        dimension: "File Inclusion",
        keywords: ["copy . .", "copy ./ /", "add . ."],
        conclusion: "overbroad_copy",
        weight: 0.85,
      },
      {
        id: "dk-hlt-1",
        dimension: "Healthcheck",
        keywords: ["healthcheck", "health check"],
        conclusion: "healthcheck_missing",
        weight: 0.75,
      },
      {
        id: "dk-port-1",
        dimension: "Port Exposure",
        keywords: ["expose 22", "expose 3306", "expose 5432", "expose 27017"],
        conclusion: "sensitive_port_exposed",
        weight: 0.9,
      },
      {
        id: "dk-add-1",
        dimension: "Dockerfile Instructions",
        keywords: ["add http", "add ftp", "add s3"],
        conclusion: "add_vs_copy_recommendation",
        weight: 0.7,
      },
      {
        id: "dk-layer-1",
        dimension: "Layer Optimization",
        keywords: ["run apt-get", "run yum", "run apk", "npm install"],
        conclusion: "layer_caching_optimization",
        weight: 0.65,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        conclusion: "o_n_squared",
        weight: 0.95,
      },
      {
        id: "ac-n3-1",
        dimension: "Cubic",
        keywords: ["triple loop", "three nested", "n cubed"],
        conclusion: "o_n_cubed",
        weight: 0.98,
      },
      {
        id: "ac-log-1",
        dimension: "Logarithmic",
        keywords: [
          "binary search",
          "divide and conquer",
          "mid",
      ...
      },
      {
        id: "ac-hash-1",
        dimension: "Constant",
        keywords: ["hashmap", "dictionary", "set lookup", "hash table", "o(1)"],
        conclusion: "o_constant",
        weight: 0.85,
      },
      {
        id: "ac-rec-1",
        ...
        conclusion: "recursion_complexity_check",
        weight: 0.9,
      },
      {
        id: "ac-sort-1",
        ...
        conclusion: "o_n_log_n",
        weight: 0.85,
      },
      {
        id: "ac-mem-1",
        dimension: "Space Complexity",
        keywords: ["array", "list", "buffer", "copy", "clone", "cache", "memo"],
        conclusion: "space_complexity_check",
        weight: 0.8,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        conclusion: "boundary_test_needed",
        weight: 0.95,
      },
      {
        id: "tc-null-1",
        dimension: "Null/Edge Cases",
        keywords: [
          "null",
          "undefined",
          "empty",
      ...
      },
      {
        ...
        conclusion: "async_test_patterns",
        weight: 0.85,
      },
      {
        id: "tc-mock-1",
        ...
        conclusion: "mock_strategy",
        weight: 0.8,
      },
      {
        id: "tc-prop-1",
        dimension: "Property-Based",
        keywords: ["invariant", "property", "forall", "arbitrary", "generator"],
        conclusion: "property_based_test",
        weight: 0.75,
      },
    ]),
  },
...
- Missing \`loading\` and \`error\` states for async ops`,
    ...
    rules: makeRules([
      {
        id: "rc-hook-1",
        dimension: "Hooks Rules",
        keywords: ["if (", "usestate", "useeffect", "conditional", "loop"],
        conclusion: "conditional_hook_violation",
        weight: 1.0,
      },
      {
        id: "rc-dep-1",
        dimension: "Dependencies",
        keywords: ["useeffect", "usecallback", "usememo", "[]", "dependency"],
        conclusion: "dependency_array_check",
        weight: 0.95,
      },
      {
        id: "rc-perf-1",
        ...
        conclusion: "memoization_opportunity",
        weight: 0.85,
      },
      {
        id: "rc-key-1",
        dimension: "List Keys",
        keywords: ["map(", ".map(", "key=", "index as key", "key={index}"],
        conclusion: "key_prop_check",
        weight: 0.9,
      },
      {
        id: "rc-a11y-1",
        ...
        conclusion: "accessibility_check",
        weight: 0.9,
      },
      {
        id: "rc-state-1",
        ...
        conclusion: "state_pattern_check",
        weight: 0.8,
      },
      {
        id: "rc-err-1",
        ...
        conclusion: "error_boundary_check",
        weight: 0.85,
      },
    ]),
  },
...
Email AI assistants: SaneBox, Superhuman — open inbox patterns`,
    ...
    rules: makeRules([
      ...
      },
      {
        ...
        conclusion: "low_priority",
        weight: 0.85,
      },
      {
        id: "em-act-1",
        dimension: "Action Required",
        keywords: [
          "please",
          "can you",
          "could you",
      ...
      },
      {
        ...
        conclusion: "formal_tone",
        weight: 0.85,
      },
      {
        id: "em-tone-2",
        dimension: "Tone",
        keywords: ["hey", "hi there", "cheers", "thanks!", "awesome", "!"],
        conclusion: "casual_tone",
        weight: 0.8,
      },
      {
        id: "em-len-1",
        dimension: "Reply Length",
        keywords: ["quick question", "yes or no", "confirm", "brief update"],
        conclusion: "short_reply_appropriate",
        weight: 0.8,
      },
      {
        id: "em-len-2",
        ...
        conclusion: "long_reply_appropriate",
        weight: 0.75,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        conclusion: "technical_risk_high",
        weight: 0.9,
      },
      {
        id: "pr-time-1",
        ...
        conclusion: "timeline_risk",
        weight: 0.9,
      },
      {
        id: "pr-budg-1",
        dimension: "Budget Risk",
        keywords: [
          "over budget",
          "cost overrun",
          "scope creep",
        ...
        conclusion: "budget_risk",
        weight: 0.85,
      },
      {
        id: "pr-peop-1",
        dimension: "People Risk",
        keywords: [
          "key person",
        ...
        conclusion: "people_risk",
        weight: 0.9,
      },
      {
        id: "pr-ext-1",
        dimension: "External Risk",
        keywords: [
          "regulatory",
          "compliance",
          "market change",
      ...
      },
      {
        ...
        conclusion: "mitigation_strategy_present",
        weight: 0.85,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        conclusion: "ats_formatting_risk",
        weight: 0.9,
      },
      {
        id: "rv-kw-1",
        ...
        conclusion: "keyword_coverage_check",
        weight: 0.9,
      },
      {
        id: "rv-imp-1",
        ...
        conclusion: "quantified_achievement",
        weight: 0.95,
      },
      {
        id: "rv-star-1",
        dimension: "STAR Format",
        keywords: [
          "result",
          "outcome",
          "achieved",
        ...
        conclusion: "star_structure_check",
        weight: 0.85,
      },
      {
        id: "rv-gap-1",
        ...
        conclusion: "skill_gap_identified",
        weight: 0.85,
      },
      {
        id: "rv-li-1",
        ...
        conclusion: "linkedin_completeness",
        weight: 0.75,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        conclusion: "personality_trait_detected",
        weight: 0.85,
      },
      {
        id: "bv-tone-1",
      ...
      },
      {
        ...
        conclusion: "jargon_detected",
        weight: 0.8,
      },
      {
        id: "bv-sent-1",
        dimension: "Sentence Style",
        keywords: [
          "long sentence",
          "complex",
          "comma",
        ...
        conclusion: "complex_sentence_style",
        weight: 0.75,
      },
      {
        id: "bv-cta-1",
    ...
    rules: makeRules([
      {
        ...
        conclusion: "keyword_strategy_present",
        weight: 0.95,
      },
      {
        id: "seo-int-1",
        ...
        conclusion: "intent_matched",
        weight: 0.9,
      },
      {
        id: "seo-head-1",
        dimension: "Heading Structure",
        keywords: ["h1", "h2", "h3", "heading", "subheading", "section"],
        conclusion: "heading_hierarchy_check",
        weight: 0.85,
      },
      {
        id: "seo-eat-1",
      ...
      },
      {
        ...
        conclusion: "faq_section_recommended",
        weight: 0.8,
      },
      {
        id: "seo-int-2",
        ...
        conclusion: "internal_linking_strategy",
        weight: 0.8,
      },
      {
        id: "seo-sch-1",
        ...
        conclusion: "schema_markup_recommended",
        weight: 0.75,
      },
    ]),
  },
    ...
    rules: makeRules([
      {
        ...
        conclusion: "problem_clearly_stated",
        weight: 0.95,
      },
      {
        id: "pd-prob-2",
        ...
        conclusion: "problem_evidence_present",
        weight: 0.9,
      },
      {
        id: "pd-mkt-1",
        ...
        conclusion: "market_sized",
        weight: 0.9,
      },
      {
        id: "pd-mkt-2",
        dimension: "Market Sizing Method",
        keywords: ["bottom-up", "top-down", "addressable", "segment"],
        conclusion: "sizing_methodology_check",
        weight: 0.85,
      },
      {
        id: "pd-trac-1",
        ...
        conclusion: "traction_demonstrated",
        weight: 0.95,
      },
      {
        id: "pd-team-1",
      ...
      },
      {
        ...
        conclusion: "competitive_landscape",
        weight: 0.85,
      },
      {
        id: "pd-ask-1",
...
async function main() {
  ...
  for (const [index, pkg] of COMMUNITY_SKILLS.entries()) {
    ...
    if (existing) {
      console.log(
        `  skip (${index + 1}/${COMMUNITY_SKILLS.length}): ${pkg.packageId}`,
      );
      skipped++;
      continue;
    }
    ...
    created++;
    console.log(
      `  + (${index + 1}/${COMMUNITY_SKILLS.length}) ${pkg.displayName}`,
    );
  }
