...
async function publish() {
  const body = {
    ...
    description:
      "Expert prompt engineering skill that analyzes, scores and optimizes AI prompts for clarity, specificity, and output quality. Evaluates structure, constraints, and edge case handling.",
...
Output: Clarity 3/10, Specificity 2/10 — suggests adding breed, tone, length, audience constraints.`,
  ...
  if (res.ok) {
    ...
    const rules = JSON.stringify([
      {
        ...
        dimension: "Clarity",
        condition: {
          keywords: ["vague", "unclear", "something", "stuff", "things", "etc"],
        },
        conclusion: "low_clarity",
        weight: 0.9,
      },
      {
        id: "clarity-002",
      ...
      },
      {
        ...
        condition: {
          keywords: ["any format", "whatever", "up to you", "your choice"],
        },
        conclusion: "low_specificity",
        weight: 0.85,
      },
      {
        id: "spec-002",
      ...
      },
      {
        ...
        dimension: "Structure",
        condition: {
          keywords: ["first", "then", "finally", "step 1", "phase"],
        },
        conclusion: "good_structure",
        weight: 0.6,
      },
      {
        id: "edge-001",
    ...
    if (encRes.ok) {
      ...
      console.log(
        "   Content hash:",
        encData.contentHash?.substring(0, 16) + "...",
      );
    } else {
